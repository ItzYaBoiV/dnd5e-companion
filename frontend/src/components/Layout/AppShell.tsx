...
export default function AppShell() {
  ...
  return (
    <div className="flex h-[100dvh] overflow-hidden bg-dnd-darker flex-col md:flex-row">
      <aside
        className={clsx(
      ...
      <main className="flex-1 min-h-0 min-w-0 overflow-y-auto overflow-x-hidden pb-[calc(4.75rem+env(safe-area-inset-bottom,0px))] md:pb-0">
        <Outlet />
      </main>
