...
export default function DungeonForge(){
  ...
  return(
    <div style={{minHeight:"100vh",background:S.bg,color:S.textColor,fontFamily:"'Courier New',monospace",fontSize:13}}>
      ...
      <div style={{display:"flex",flexWrap:"wrap"}}>
        <div style={{width:258,minWidth:258,padding:"8px 10px",borderRight:`1px solid ${S.panelBorder}`,background:S.panelBg,display:"flex",flexDirection:"column",gap:6,maxHeight:"calc(100vh - 36px)",overflowY:"auto"}}>
          <LB S={S}>LOCATION</LB>
